...
SEGMENTS: list[SegmentMeta] = [
    {
        "key": "gba", "start": SERIES_START, "end": SEG_A_END,
    ...
    {
        "key": "sanluis", "start": SEG_B_START, "end": SEG_B_END,
    ...
    {
        "key": "nacional", "start": SEG_C_START, "end": DATA_VINTAGE,
...
INDEC_NACIONAL_ANNUAL = {
    2017: 24.8, 2018: 47.6, 2019: 53.8, 2020: 36.1,
    2021: 50.9, 2022: 94.8, 2023: 211.4, 2024: 117.8,
}
...
SANLUIS_ANNUAL = {
    2007: 21.5, 2008: 20.6, 2009: 18.5, 2010: 27.0, 2011: 23.3,
    2012: 23.0, 2013: 31.9, 2014: 39.0, 2015: 31.6,
}
